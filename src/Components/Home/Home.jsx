...
function Home() {
  ...
  return (
    <>
      <div class="relative w-full bg-red-950 text-white">
        <div class="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8 text-white">
          <div class="flex flex-col justify-center px-4 py-12 md:py-16 lg:col-span-7 lg:gap-x-6 lg:px-6 lg:py-24 xl:col-span-6">
            ...
            <div class="mt-8 flex max-w-max items-center space-x-2 rounded-full p-1">
              <div class="rounded-full text-white p-1 px-2">
                <p class="text-sm font-medium text-white">We better </p>
              </div>
              <p class="text-sm font-medium">Service Provider →</p>
            </div>
            <h1 class="text-white mt-8 text-3xl font-bold tracking-tight text-black md:text-4xl lg:text-6xl">
              People who care about your money
            </h1>
            <p class="mt-8 text-lg text-white">
              Welcome to Banking System here your money is safe with world class
              security
            </p>
