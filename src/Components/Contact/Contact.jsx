            ...
            <div class="grid md:grid-cols-2">
              <div class="h-full pr-6">
                <p class="mt-3 mb-12 text-lg text-gray-600 dark:text-slate-400">
                  conatact page can not be skiped because here chanse to connect
                  with our team very effectively
                </p>
                <ul class="mb-6 md:mb-0">
                  <li class="flex">
                    ...
                    <div class="ml-4 mb-4">
                      ...
                      <p class="text-gray-600 dark:text-slate-400">
                        1230 Electronic city metro sec Noida sec 62
                      </p>
                      <p class="text-gray-600 dark:text-slate-400">
                        India, Ruppe
                      </p>
                  ...
                  <li class="flex">
                    ...
                    <div class="ml-4 mb-4">
                      ...
                      <p class="text-gray-600 dark:text-slate-400">
                        Mobile: +91 9149256959
                      </p>
                      <p class="text-gray-600 dark:text-slate-400">
                        Mail: mohdanashasmi@gmail.com
                      </p>
                    </div>
                  </li>
                  <li class="flex">
              ...
              <div class="card h-fit max-w-6xl p-5 md:p-12" id="form">
                <h2 class="mb-4 text-2xl font-bold ">Enter your data </h2>
                <form id="contactForm">
                  <div class="mb-6">
