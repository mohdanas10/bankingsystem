...
function CreateAccount() {
  ...
  const submitHandler = async () => {
    let count = 0;
    if (name.length < 4) {
      setNameError("Name must be four characters !!");
      count = 1;
    }
    if (age < 16) {
      setAgeError("you'r not eligible for account ");
      count = 1;
    }
    if (aadhar.length > 12 || aadhar.length < 12) {
      setAadharError("plz must be 12 numbers !! ");
      count = 1;
    }
    if (sex.length < 4) {
      setSexError("plz enter the valid Gender !!");
      count = 1;
    }
    if (owner != "Anas@580") {
            ...
            <div class="relative">
              <div class="w-full max-w-xl xl:mx-auto xl:w-full xl:max-w-xl xl:pr-24">
                <h3 class="text-4xl font-bold text-white">
                  Strats Transactions with an Account
                </h3>
              ...
              <form>
                <div class="space-y-5">
                  ...
                  <div>
                    ...
                    <p className="text-red-500">{aadharError}</p>
                    <div class="mt-2">
                      <input
